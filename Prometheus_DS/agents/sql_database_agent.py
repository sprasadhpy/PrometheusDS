...
from Prometheus_DS.parsers.parsers import SQLOutputParser
...
from Prometheus_DS.tools.sql import get_database_metadata
...
class SQLDatabaseAgent(BaseAgent):
    ...
    from Prometheus_DS.agents import SQLDatabaseAgent
...
def make_sql_database_agent(
    ...
    --------
    ```python
    from Prometheus_DS.agents import make_sql_database_agent
    import sqlalchemy as sql
    from langchain_openai import ChatOpenAI
